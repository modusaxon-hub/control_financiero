            ...
            >
                ...
                <form action={signUp} className="flex flex-col gap-4">
                    ...
                    <div style={{ fontSize: 12, color: "var(--text-secondary)" }}>
                        ...
                        <Link href="/terms" style={{ color: "var(--color-info)", textDecoration: "underline" }}>
                ...
                <form action={signInWithGoogle} className="w-full">
                    <Button type="submit" variant="secondary" fullWidth style={{ color: "var(--text)", borderColor: "var(--border-color)" }}>
